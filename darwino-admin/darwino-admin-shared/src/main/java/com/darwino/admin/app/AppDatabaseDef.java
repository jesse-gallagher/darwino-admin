...
public class AppDatabaseDef extends DatabaseFactoryImpl {
	...
	public static final String DATABASE_NAME	= "darwinoadmin";
	...
	public static String[] getInstances() {
		...
		String inst = Platform.getProperty("darwinoadmin.instances");
	...
	public _Database loadDatabase(String databaseName) throws JsonException {
		if(StringUtil.equalsIgnoreCase(databaseName, DATABASE_NAME)) {
			return loadDatabase_darwinoadmin();
		}
		return null;
	}
	
	public _Database loadDatabase_darwinoadmin() throws JsonException {
		_Database db = new _Database(DATABASE_NAME, "Darwino Admin", DATABASE_VERSION);
