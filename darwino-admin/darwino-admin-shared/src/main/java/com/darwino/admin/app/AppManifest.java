...
public class AppManifest extends DarwinoManifest {
	...
	public static String CONFIG_ID = "darwinoadmin";
	
	// This is used by the mobile application to call the remote service
	public static final String MOBILE_PATHINFO	= "darwinoadmin";
	...
	public String getLabel() {
		return "Darwino Admin";
	}
	
	@Override
	public String getDescription() {
		return "Darwino generic admin application";
	}
